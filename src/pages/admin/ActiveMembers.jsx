                      ...
                      <td className="px-3 py-3 text-sm">
                        <div className="flex items-center justify-center gap-2">
                          ...
                          <button
                            ...
                            className={`inline-flex items-center px-3 py-1.5 transition-colors text-xs font-medium ${item.accountStatus === "blocked"
                    ...
                    if (pageNumber > 0 && pageNumber <= totalPages) {
                      return (
                        <button
                          ...
                          className={`px-3 py-2 text-sm transition-colors ${currentPage === pageNumber
