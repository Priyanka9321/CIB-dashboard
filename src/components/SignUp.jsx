    ...
    try {
      ...
      if (response.status === 201) {
        const userData = {
          ...
          role: "user",
          status: "inactive", // Reflect initial status
        };
        setUser(userData);
        ...
        navigate("/sign-in"); // Redirect to sign-in page as account is inactive
      }
    } catch (error) {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2.5 border focus:ring-2 focus:ring-blue-500 ${
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={handleChange}
                className={`w-full px-3 py-2.5 pr-10 border focus:ring-2 focus:ring-blue-500 ${
